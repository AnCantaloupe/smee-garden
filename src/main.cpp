...
ResetState(state *State) {
    State->co = { 0.0f, 0.0f, 0.0f };
    State->Theta = Pi32/2.0f;
    State->Phi   = 0.0f;
    State->iTime = 0.0f;
}
...
Main(memory *Memory, input *Input, window_information WindowInformation) {
    ...
    Theta += 0.1f * Input->TimeStepFrame * (ButtonDown(Input->Buttons[BUTTON_Left]) - ButtonDown(Input->Buttons[BUTTON_Right]));
    ...
    string DateText  = STRING_FROM_LITERAL("1 5   M A R C H\n\
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  W E D   W E E K   3");
    string TimeText  = STRING_FROM_LITERAL("1 2 - 2 P M");
